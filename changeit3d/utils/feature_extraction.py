"""
Routines to extract features (latents) from image datasets.
"""
...
from ..in_out.image import ImageClassificationDataset
from ..in_out.image import image_net_mean, image_net_std
...
def image_transformation(img_dim, pretraining='image_net'):
    ...
    res = transforms.Compose([transforms.Resize((img_dim, img_dim), transforms.InterpolationMode.LANCZOS),
