## Note:
## Code copied from: https://github.com/fxia22/pointnet.pytorch
## Original copyright Fei Xia
## Purpose of copying/storing in changeit3d; to slightly edit the preprocessing step of the input pointclouds to bring it closer to ShapeTalk.
